export SPARK_DAEMON_JAVA_OPTS="-Dspark.deploy.recoveryMode=ZOOKEEPER -Dspark.deploy.zookeeper.url=%BD_ZOOKEEPER_SERVERS% -Dspark.deploy.zookeeper.dir=/%BD_SUITE_PREFIX%-spark"
