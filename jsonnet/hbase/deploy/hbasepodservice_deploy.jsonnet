{
  ...
  _zkprefix: "pre1",
  _hdfsprefix: "pre1",
  _zkservers:: std.join(",", [$._zkprefix + "-" + "zookeeper" + zknum + ":2181" for zknum in std.range(1,$._zknum)]),
  ...
  []) + [
    ...
    (import "../hmaster.jsonnet") + {
      ...
      _s3utilspath: self._hmasterprefix + "-" + cephbasename[0],
    ...
    (import "../regionserver.jsonnet") + {
      ...
      _dockerimage: $._hbasedockerimage,
      _s3utilspath: self._rsprefix + "-" + cephbasename[0],
      _typeofutilsstorage: $._utilsstoretype,
      _initcontainerimage: $._initcontainerimage,
