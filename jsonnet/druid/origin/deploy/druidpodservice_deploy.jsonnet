{
  ...
  _journalnodeservers::  std.join(";", [$._hdfsprefix + "-" + "journalnode" + jnnum + ":8485" for jnnum in std.range(1,$._jninstancecount)]),
  _mysqlpasswd:: "123456",
  _mysqlusername:: "root",
  _amahserver:: $._suiteprefix + "-" + "amahdruid" + ":8084",
  _componentoramah:: "both",
  ...
  []) + [
    ...
    (import "../broker.jsonnet") + {
      ...
      _s3utilspath: self._brokerprefix + "-" + cephbasename[0],
      ...
      _envs: [
        ...
        "BD_HDFS_PREFIX:" + $._hdfsprefix,
        "BD_MYSQL_PREFIX:" + $._mysqlprefix,
        ...
        "BD_AMAH_SERVER:" + $._amahserver,
        "BD_COMPONENT_OR_AMAH:" + $._componentoramah,
      ],
  ...
  []) + [
    ...
    (import "../coordinator.jsonnet") + {
      ...
      _mname: self._coordinatorprefix + "-" + super._mname + coordinatornum,
      _dockerimage: $._druiddockerimage,
      _s3utilspath: self._coordinatorprefix + "-" + cephbasename[0],
      _typeofutilsstorage: $._utilsstoretype,
      _initcontainerimage: $._initcontainerimage,
    ...
    (import "../historical.jsonnet") + {
      ...
      _dockerimage: $._druiddockerimage,
      _s3utilspath: self._historicalprefix + "-" + cephbasename[0],
      _typeofutilsstorage: $._utilsstoretype,
      _initcontainerimage: $._initcontainerimage,
    ...
    (import "../middlemanager.jsonnet") + {
      ...
      _dockerimage: $._druiddockerimage,
      _s3utilspath: self._middlemanagerprefix + "-" + cephbasename[0],
      _typeofutilsstorage: $._utilsstoretype,
      _initcontainerimage: $._initcontainerimage,
  ...
  []) + [
    ...
    (import "../overlord.jsonnet") + {
      ...
      _mname: self._overlordprefix + "-" + super._mname + overlordnum,
      _dockerimage: $._druiddockerimage,
      _s3utilspath: self._overlordprefix + "-" + cephbasename[0],
      _typeofutilsstorage: $._utilsstoretype,
      _initcontainerimage: $._initcontainerimage,
