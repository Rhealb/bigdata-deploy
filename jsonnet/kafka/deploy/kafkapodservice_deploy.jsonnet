{
  ...
  _zkinstancecount:: 3,
  _zkprefix:: "pre1",
  _zkservers:: std.join(",", [$._zkprefix + "-" + "zookeeper" + zknum + ":2181" for zknum in std.range(1,$._zkinstancecount)]) + "/" + $._suiteprefix + "-kafka",
  ...
  []) + [
    ...
    (import "../kafka.jsonnet") + {
      ...
      _s3utilspath: self._kafkaprefix + "-" + cephbasename[0],
